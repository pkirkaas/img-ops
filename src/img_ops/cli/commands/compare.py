...
app = typer.Typer(
    name="compare", help="Compare images based on various criteria.")


@app.command("checksum")
def compare_checksums(
    files: Annotated[List[str], typer.Argument(
        help="Two or more image files to compare by checksum.")]
):
    """
...
def compare_phashes(
    ...
    """
    print(
        f"Placeholder: Comparing perceptual hashes for '{file1}' and '{file2}'")
    # Future implementation:
