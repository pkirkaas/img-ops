...
class ResizeContainer(QWidget):
    ...
    def __init__(
        ...
        if initial_size:
            # Sets the initial size of the ResizeContainer widget
...
if __name__ == '__main__':
    ...
    h_container = ResizeContainer(
        orientation=Qt.Orientation.Horizontal, background_color="lightgray")
    ...
    v_container_main = ResizeContainer(
        orientation=Qt.Orientation.Vertical, background_color="#f0f0f0")

    # Top horizontal container
    h_container_top = ResizeContainer(
        orientation=Qt.Orientation.Horizontal, background_color="lightblue")
    ...
    h_container_bottom = ResizeContainer(
        orientation=Qt.Orientation.Horizontal, background_color="lightcoral")
    ...
    # Initial relative sizes for vertical split
    v_container_main.setWidgetSizes([150, 150])
